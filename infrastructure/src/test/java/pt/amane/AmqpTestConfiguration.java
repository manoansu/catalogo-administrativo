 ...
 *  This class will be scanned every time the spring context comes up to configure the AMQ part of our test.
 */
@Configuration
...
public class AmqpTestConfiguration {
    ...
    /**
     * Instatiate and open connection from spring with rabbitmq.
     * @return
     */
    @Bean
