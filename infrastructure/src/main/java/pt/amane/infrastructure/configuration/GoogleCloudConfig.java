...
import pt.amane.infrastructure.configuration.proprieties.GoogleCloudProperties;
import pt.amane.infrastructure.configuration.proprieties.GoogleStorageProperties;
...
public class GoogleCloudConfig {
  ...
  public Credentials credentials(final GoogleCloudProperties props) throws IOException {
    final var jsonBin = Base64.getDecoder()
        .decode(Objects.requireNonNull(props.getCredentials())); // decode json properties fom base64..
