...
class VideoTest {
  ...
  @Test
  void givenValidVideo_whenCallsUpdate_shouldReturnUpdated() throws InterruptedException {
    // given
    final var expectedTitle = "System Design Interviews";
    final var expectedDescription = """
                Disclaimer: o estudo de caso apresentado tem fins educacionais e representa nossas opiniões pessoais.
  ...
  @Test
  void givenValidVideo_whenCallsUpdateVideoMedia_shouldReturnUpdated() throws InterruptedException {
    // given
    final var expectedTitle = "System Design Interviews";
    final var expectedDescription = """
                Disclaimer: o estudo de caso apresentado tem fins educacionais e representa nossas opiniões pessoais.
...
//    final var actualEvent = (VideoMediaCreated) acmob
